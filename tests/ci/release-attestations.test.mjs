...
const statement = {
  ...
  predicate: {
    buildDefinition: {
      ...
      externalParameters: {
        workflow: {
          repository: 'https://github.com/taucad/libassimp',
      ...
      resolvedDependencies: [
        {
          uri: 'git+https://github.com/taucad/libassimp@refs/heads/main',
    ...
    runDetails: {
      ...
      metadata: {
        invocationId: 'https://github.com/taucad/libassimp/actions/runs/123/attempts/1',
      },
    },
  },
};
